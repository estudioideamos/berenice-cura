export const book = {
  ...
  description:
    "Una invitación a comprender la hipoacusia, la sordera y el derecho a comunicarse, y a descubrir otras formas de escuchar el mundo: con la mirada, las manos, las emociones y la presencia.",
  purpose:
