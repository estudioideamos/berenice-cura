...
const pages = [
  ...
  { path: "tienda/mi-mama/index.html", title: "Mi Mamá | Tienda ACCSHT" },
...
const requiredAssets = [
  ...
  "tienda-editorial.webp", "colaboraciones-editorial.webp", "luna-cover.webp", "mi-mama-cover.webp", "mi-mama-thumb.webp",
